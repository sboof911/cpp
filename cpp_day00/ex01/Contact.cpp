...
/*   Updated: 2022/03/06 16:55:30 by amaach           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Contact::search_index(int indeX )
{
	...
	{
		std::cout << "  Index   |First name| Last name| Nickname |Phonenumbr|Darkest_secret" << std::endl;
		std::cout << std::setw(10);
		std::cout << this->_index;
		std::cout << "|";
		std::cout << std::setw(10);
		...
		std::cout << "|";
		std::cout << std::setw(10);
		std::cout << set_string(this->_NickName);
		std::cout << "|";
		std::cout << std::setw(10);
		std::cout << set_string(this->_Phone_Number);
		std::cout << "|";
		std::cout << std::setw(10);
		std::cout << set_string(this->_Darkest_secret) << std::endl;
	}
}